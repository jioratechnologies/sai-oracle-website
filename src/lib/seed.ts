...
export const seedVideos: YoutubeVideo[] = [
  ...
  {
    id: "seed-v2",
    title: "Shirdi Sai Baba Dhoop Aarti (Evening Aarti)",
    youtube_url: "https://www.youtube.com/watch?v=W1llxubfP_U",
    thumbnail_url: null,
    published: true,
    created_at: "2026-09-01T00:00:00Z",
  },
  {
    id: "seed-v3",
    title: "Om Sai Namo Namah — Sai Mantra by Suresh Wadkar",
    youtube_url: "https://www.youtube.com/watch?v=7oSd7ZugNeM",
    thumbnail_url: null,
    published: true,
    created_at: "2026-09-01T00:00:00Z",
  },
